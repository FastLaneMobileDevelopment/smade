package io.bega.servicebase.actionbar;
...
public class ActionBarConfig {
	...
	private final boolean enableDrawerLayout;
	private final int menuIdRes;

	ActionBarConfig(Builder builder) {
		title = builder.title;
		visible = builder.visible;
		enableHomeAsUp = builder.enableHomeAsUp;
		enableDrawerLayout = builder.enableDrawerLayout;
		menuIdRes = builder.menuIdRes;
	}
	...
	public boolean isDrawerLayoutEnabled() {return enableDrawerLayout; }

	public int getMenuIdResource() { return menuIdRes; }
	...
	public static class Builder {
		...
		private boolean enableDrawerLayout = false;
		private int menuIdRes = 0;
		...
		public Builder enableDrawerLayout(boolean enabled)
		{
			this.enableDrawerLayout = enabled;
			return this;
		}

		public Builder setMenu(@MenuRes int menu)
		{
			this.menuIdRes = menu;
			return this;
		}
