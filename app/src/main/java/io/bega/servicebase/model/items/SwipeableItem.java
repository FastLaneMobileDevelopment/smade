...
public class SwipeableItem extends AbstractItem<SwipeableItem, SwipeableItem.ViewHolder>  {
    ...
    public SwipeableItem withType(int type)
    {
        this.type = type;
        return this;
    }
    ...
    public void bindView(ViewHolder viewHolder) {
       ...
       // viewHolder.swipeType.setBackgroundColor(Color.BLUE);
        ...
        if (swipedDirection != 0) {
            ...
            swipedText = swipedDirection == ItemTouchHelper.LEFT ? viewHolder.itemView.getContext().getString(R.string.action_delete) : viewHolder.itemView.getContext().getString(R.string.action_archive);
